...
namespace Atomic.Entities
{
    public partial class SceneEntity
    {
        ...
        [LabelText("Name")]
        private string NameDebug => this.entity?.Name ?? this.name;

        [FoldoutGroup("Debug")]
        [LabelText("Initialized")]
        [ShowInInspector, ReadOnly]
        private bool InitializedDebug => this.entity?.Initialized ?? false;

        [FoldoutGroup("Debug")]
        [ShowInInspector, ReadOnly]
        [LabelText("Enabled")]
        private bool EnabledDebug => this.entity?.Enabled ?? false;
        ...
        private List<TagElement> TagElememts
        {
            get
            {
                ...
                IReadOnlyCollection<int> tags = this.entity?.Tags;
                if (tags == null)
        ...
        {
            if (this.entity != null) this.DelTag(tagElement.id);
        }

        private void RemoveTagElementAt(int index)
        {
            if (this.entity != null) this.DelTag(this.TagElememts[index].id);
        }
        ...
        private List<ValueElement> ValueElements
        {
            get
            {
                ...
                IReadOnlyDictionary<int, object> values = this.entity?.Values;
                if (values == null)
        ...
        {
            if (this.entity != null) this.DelValue(valueElement.id);
        }

        private void RemoveValueElementAt(int index)
        {
            if (this.entity != null) this.DelValue(this.ValueElements[index].id);
        }
        ...
        {
            if (this.entity != null) this.DelBehaviour(behaviourElement.value);
        }

        private void RemoveLogicElementAt(int index)
        {
            if (this.entity != null) this.DelBehaviour(this.BehaviourElements[index].value);
        }
